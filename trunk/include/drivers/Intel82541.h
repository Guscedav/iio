...
#ifndef INTEL_82541_H_
#define INTEL_82541_H_
...
/**
 * This class implements a specific Ethernet device driver for PCI boards with an Intel 82541 Ethernet controller.
 * An example is the Intel Pro/1000 GT desktop PCI board depicted below.
 * <div style="text-align:center"><img src="intel82541.jpg" width="500"/></div>
 * <br/>
 * <div style="text-align:center"><b>An Intel Pro/1000 GT PCI board</b></div>
 */
class Intel82541 : public Ethernet {
    
    public:
        
                    Intel82541(PCI& pci, uint16_t number, uint32_t speed, bool loopback);
        virtual     ~Intel82541();
        bool        link();
    ...
    private:
        ...
        static const uint16_t   DEVICE_ID = 0x107C;     // device ID of this board
        ...
        static const uint32_t   RDBAL = 0x2800;         // receive descriptor base address low
        static const uint32_t   RDBAH = 0x2804;         // receive descriptor base address high
        static const uint32_t   RDLEN = 0x2808;         // receive descriptor length
        static const uint32_t   RDH = 0x2810;           // receive descriptor head
        static const uint32_t   RDT = 0x2818;           // receive descriptor tail
